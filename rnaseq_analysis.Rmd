...
knitr::opts_chunk$set(echo = TRUE, warning=FALSE, message=FALSE, fig.width=12, fig.height=8, fig.path='figure_')
```
...
setwd("~/analysis/miscanthus-rnaseq-Msin/kallisto/deseq2-kallisto")
```
...
#####INPUTS
load("../txi_import.R") #this loads the object 'mytxi' from the tximport step
dim(mytxi$counts) 
#View(mytxi$counts)
...
pheno <- read.delim("../../pheno.txt", header = T, sep = '\t')
